...
public class Vote{             
   public static void main(String[]args)
   {
      ...
      while(count<limit)
      {
         String s=JOptionPane.showInputDialog("Shkruani emrin tuaj");
         ...
         {
            String g=JOptionPane.showInputDialog("Shtypni 1 ose 2,perkatesisht zgjidhni se cilin nga kandidatet doni ta votoni ");
            ...
            else
            {
               ...
               {
                  JOptionPane.showMessageDialog(null, "Faleminderit " +s+ " qe votuat per kandidatin numer 2");  		    	
               		 ...
               		 
               {
                  ...
                  JOptionPane.showMessageDialog(null, "Gabim: lejohet te shtypet vetem 1 ose 2 pasi qe jane 2 kandidate ");
               }
               count++;
